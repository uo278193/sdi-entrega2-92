...
public class PO_NavView extends PO_View {
    ...
    public static void adminDropdown(WebDriver driver, String option){
        List<WebElement> gestUsersButton = SeleniumUtils.waitLoadElementsBy(driver, "id", "adminDropdown", getTimeout());
        gestUsersButton.get(0).click();
        //Esperamos a que aparezca el menú de opciones.
        SeleniumUtils.waitLoadElementsBy(driver, "id", "adminDropdownMenuButton", getTimeout());
